...
class _StoreScreenState extends State<StoreScreen> {
  ...
  void _onCompactChipTapped(int index) {
  ...
  Widget build(BuildContext context) {
    ...
    // Top picks: newest 12 products across all stores
    final topPicks = List<Map<String, dynamic>>.from(allProducts)
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Section 3 — More Stores Compact Row
                      StoreCompactRow(
                        stores: _stores,
                        focusedIndex: _focusedIndex,
                        onStoreTapped: _onCompactChipTapped,
                      ),

                      // Section 4 — Cross-Store Top Picks
                      CrossStoreProductRow(products: topPicksLimited),
