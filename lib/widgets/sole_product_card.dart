...
class SoleProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String imageUrl = images.isNotEmpty 
        ? images.first 
        : 'https://images.unsplash.com/photo-1549298916-b41d501d3772?q=80&w=600&auto=format&fit=crop'; // Premium shoe stock image
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Top half: Hero image bleeding to edges
            Expanded(
              child: Stack(
                children: [
                  ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => Container(
                        color: AppConstants.borderGray.withOpacity(0.3),
                        child: const Icon(Icons.broken_image_outlined, color: AppConstants.primary),
                      ),
                    ),
                  ),
