...
| `screens/auth/` | `role_choice_screen`, `customer_register_screen`, `seller_application_flow`, `foot_profile_onboarding_screen`, `pending_approval_screen`, login, splash, onboarding, edit_profile | [[obsidian/MOCs/00 - Auth & Accounts|🔐 Auth]] |
